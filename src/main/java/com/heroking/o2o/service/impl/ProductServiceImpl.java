...
import com.heroking.o2o.dao.ProductImgDao;
...
/**
 * @Author heroking
 * @Date 2019年11月16日 上午10:52:14 类说明
 */
@Service
public class ProductServiceImpl implements ProductService {
	...
	//2.若商品详情图列表参数有值，对商品详情图列表进行同上的操作
	...
	public ProductExecution modifyProduct(Product product, ImageHolder thumbnail, List<ImageHolder> productImgHolderList)
		...
		}else if(product.getShop()==null) {
			System.out.println("getshop null");
		}else if(product.getShop().getShopId()==null) {
			System.out.println("shopId null");
		}
		if(product!=null && product.getShop()!=null && product.getShop().getShopId()!=null) {
			//给商品设置默认属性
			product.setLastEditTime(new Date());
